...
set multiplot layout 2,1 rowsfirst
  ...
  # GRAPH 1
set title "DURATA PROG"
set label 1 '' at graph 0.92,0.9 font ',14' 
set format x "%.1f"
set xrange [0.2:2]
plot 'DURATA PROG' u 1:(\$2+4) w lines ls 1 t 'Reset', \\
	'' u 3:4 w lines ls 2 t 'Halt'
...
set format x "%.1f"
set xrange [0.2:15]
plot '10S' u 1:(\$2+4) w lines ls 1 t 'Reset', \\
	'' u 3:4 w lines ls 2 t 'Halt'
