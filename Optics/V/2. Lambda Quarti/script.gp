...
fit  f(x) 'data' u ($1*pi/180):($2/STATS_max):(($2*0.02+$3)/STATS_max) yerr via A,B,T0,a

#plot

plot 'data' u ($1*pi/180):($2/STATS_max):(($2*0.02+$3)/STATS_max) t 'Data' w yerrorbars ls 2 , \
	f(x) ls 1 t 'Fit'
