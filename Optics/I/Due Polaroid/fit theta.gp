...
#fit
f(x) = a*cos(x+b)*cos(x+b)
fit f(x) 'data' u ($1*3.145/180):2 via a,b


#plot

plot 'data' u ($1*3.145/180):2:(0.01) w yerrorbars t 'Data' ls 1, \
	a*cos(x+b)*cos(x+b) t 'fit' w lines ls 2

#plot 'data' u ($1*3.1459/180)*($1*3.1459/180):2:($2*0.15) w yerrorbars ls 1 t 'Data' 
